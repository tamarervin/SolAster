...
csv_name = os.path.join(CsvDir.NEID_CALC, 'jenn_spot1.csv')
...
# start_date = datetime.datetime(2021, 8, 7, 4, 30, 0)
# end_date = datetime.datetime(2021, 8, 8, 0, 00, 0)
...
for i, date in enumerate(dates_list[32:]):
